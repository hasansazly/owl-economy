...
import { ArrowLeft, Check, Eye, EyeOff, GraduationCap, LockKeyhole, Mail, User } from "lucide-react";
        ...
        <div className="page-card px-7 py-8 shadow-[0_20px_60px_rgba(0,0,0,0.28)]">
          {!submitted ? (
            ...
            <div className="py-3 text-center">
              <div className="mx-auto mb-4 flex h-[52px] w-[52px] items-center justify-center rounded-full bg-[rgba(255,62,165,0.12)]">
                <Check className="h-6 w-6 text-[var(--accent)]" />
              </div>
              <h1 className="font-display text-xl font-bold tracking-[-0.03em]">Check your inbox</h1>
